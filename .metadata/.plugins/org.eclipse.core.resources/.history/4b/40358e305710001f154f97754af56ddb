...
IFX_INTERRUPT(ISR_UART_TX, 0, ISR_PRIO_UART_TX);
void ISR_UART_TX(void)
{
    IfxAsclin_Asc_isrTransmit(&g_ascHandle);
}

IFX_INTERRUPT(ISR_UART_RX, 0, ISR_PRIO_UART_RX);
...
void initUart(void)
{
    ...
    ascConfig.interrupt.txPriority    = ISR_PRIO_UART_TX;
    ascConfig.interrupt.rxPriority    = ISR_PRIO_UART_RX;
    ...
    const IfxAsclin_Asc_Pins pins =
    {
        ...
        &PIN_UART_RX,   IfxPort_InputMode_pullUp,     /* RX pin           */
        NULL_PTR,       IfxPort_OutputMode_pushPull,  /* RTS pin not used */
        &PIN_UART_TX,   IfxPort_OutputMode_pushPull,  /* TX pin           */
