...
/*------------------------------------------------Function Prototypes------------------------------------------------*/
/*********************************************************************************************************************/
extern void taskMotorCtrl(float32 w_ref, uint8 motor_on, uint8 dir);
...
extern void taskBluetooth(uint8 *bt_on, uint8 *motor_on, uint32 time_100ms, float32 *w_ref, float32 *w_ref_1, float32 *w_ref_2, uint8 *dir);
